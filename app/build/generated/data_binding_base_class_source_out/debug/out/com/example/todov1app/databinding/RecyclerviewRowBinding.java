...
public final class RecyclerviewRowBinding implements ViewBinding {
  ...
  private RecyclerviewRowBinding(@NonNull LinearLayout rootView, @NonNull TextView itemTextView) {
  ...
  public static RecyclerviewRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerviewRowBinding((LinearLayout) rootView, itemTextView);
    }
